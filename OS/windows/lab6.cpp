...
/*
Процесс должен быть с двумя потоками. Первый поток читает файл сценарий и выполняет заданные в нем действия 
с виртуальной памятью, а второй отслеживает поведение первого.
*/
