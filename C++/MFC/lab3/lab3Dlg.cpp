...
BEGIN_MESSAGE_MAP(Clab3Dlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_EXIT_BUTTON, &Clab3Dlg::OnBnClickedExitButton)
	ON_WM_MOUSEMOVE()
	ON_WM_LBUTTONDOWN()
END_MESSAGE_MAP()
...
void Clab3Dlg::OnBnClickedExitButton()
{
	// TODO: Add your control notification handler code here
	OnOK();
}

void Clab3Dlg::OnMouseMove(UINT nFlags, CPoint point)
{
...
void Clab3Dlg::OnLButtonDown(UINT nFlags, CPoint point)
{
	// TODO: Add your message handler code here and/or call default
	m_PrevX=point.x;
	m_PrevY=point.y;
