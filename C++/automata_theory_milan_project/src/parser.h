...
public:
	...
	explicit Parser(const string& fileName) :output_(cout), error_(false), recovered_(true), lastVar_(0)
	{
...
private:
	...
	/*##########*/
	void expression(bool factorExist); //разбор арифметического выражения.
	void term(bool factorExist);
	/*##########*/
